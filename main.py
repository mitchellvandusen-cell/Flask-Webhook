...
def send_sms_via_ghl(contact_id, message, api_key, location_id):
    ...
    payload = {
        ...
        "contactId": contact_id,
        "locationId": location_id,
        "message": message  # FIX: was 'reply' (undefined) before
    }
...
[... KEEP YOUR FULL PROMPT CONTENT EXACTLY AS YOU PASTED IT ABOVE ...]
"""
...
def ghl_unified():
	...
	contact_id = (
    		...
    		data.get('contactId') or                     # Standard GHL field (capital I)
