...
def save_voice_config():
    ...
    voice_config.update({
        ...
        "dial_attempts":      max(1, min(6, int(data.get("dial_attempts") or 2))),
        ...
        "max_lines_setting":          max(1, min(4, int(data.get("max_lines_setting") or 3))),
        "wrap_up_time":               max(0, min(120, int(data.get("wrap_up_time") or 15))),
        ...
        "same_number_cooldown_hours": max(0, min(72, int(data.get("same_number_cooldown_hours") or 4))),
        "same_contact_daily_max":     max(0, min(10, int(data.get("same_contact_daily_max") or 3))),
        ...
        "max_abandon_rate_pct":       max(1.0, min(10.0, float(data.get("max_abandon_rate_pct") or 3.0))),
