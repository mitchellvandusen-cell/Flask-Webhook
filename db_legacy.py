...
# NOTE: init_db() was removed (1,733 lines of legacy DDL).
# Schema is now managed entirely by Alembic migrations in migrations/versions/.
# See 002_full_schema.py for the canonical schema definition.
