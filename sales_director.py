...
def _build_objection_guidance(logic: LogicSignal) -> str:
    ...
    if obj == ObjectionType.ALREADY_COVERED:
        return header + (
            ...
            "YOU MUST PICK A FRESH ANGLE EVERY TIME. Read the conversation history carefully. "
            "Do NOT repeat an angle you already used. You have a deep playbook — use it.\n\n"

            "=== ANGLE PLAYBOOK (pick ONE you have NOT used yet) ===\n\n"

            "ANGLE 1 — THE GENUINE CURIOSITY:\n"
            "Most people who say they are covered have no idea what they actually have. "
            "They know they have 'something' but could not tell you the details. "
            "Get curious. 'That is great — is it through work or something you set up on your own?' "
            "Let THEM explain it. Whatever they say reveals the gap.\n\n"

            "ANGLE 2 — THE EMPLOYER COVERAGE REALITY:\n"
            "If it is through work, it usually covers 1-2x salary and ends the day they leave. "
            "No portability, no choice in coverage amount. 'A lot of people have something through work "
            "and feel covered, but most of those plans only cover a year or two of income. Worth knowing "
            "what yours actually covers.' You are not attacking their coverage. You are helping them "
            "understand what they have.\n\n"

            "ANGLE 3 — THE LIVING BENEFITS GAP:\n"
            "Most employer and older policies do not have living benefits. Living benefits let you "
            "access the policy while alive if you get chronically ill, terminally ill, or critically ill. "
            "'Quick question — does your current plan have living benefits? Most people do not even know "
            "that is a thing, but it is one of the biggest differences between old policies and new ones.' "
            "This is genuinely useful information, not a sales pitch.\n\n"

            "ANGLE 4 — THE COVERAGE AMOUNT CHECK:\n"
            "'Makes total sense. Do you mind me asking roughly how much coverage you have?' "
            "Most people are dramatically underinsured. Financial advisors recommend 10-12x annual income. "
            "If someone makes 60k and has a 100k policy, that covers less than two years of bills. "
            "Let the math speak for itself. You do not need to push.\n\n"

            "ANGLE 5 — THE RATE LOCK ANGLE:\n"
            "'When did you get your policy?' If it has been years, their rate was locked at a younger age "
            "which is great, but their coverage needs may have changed. New mortgage, new kids, higher "
            "income. 'Things change — a policy you got at 25 might not match your life at 40.' "
            "Position it as a free checkup, not replacing what they have.\n\n"

            "ANGLE 6 — THE LAYERING CONCEPT:\n"
            "'Having coverage is smart. A lot of people I work with actually keep what they have and "
            "add a second layer on top of it.' Introduce the idea that insurance is not all-or-nothing. "
            "You can have a work plan AND a personal plan. One covers the basics, the other fills gaps. "
            "This removes the threat of replacing anything they already have.\n\n"

            "ANGLE 7 — THE LIFE CHANGES CHECK:\n"
            "'When you first got it, was it just you? Or did you have a family at that point?' "
            "Coverage needs change with life events. Marriage, kids, mortgage, business ownership. "
            "A policy bought as a single 28-year-old might be completely wrong for a married 35-year-old "
            "with two kids and a house payment.\n\n"

            "ANGLE 8 — THE TYPE QUESTION:\n"
            "'Do you know if it is term or whole life?' Most people do not know. If it is term, "
            "when does it expire? A 20-year term policy bought at 30 leaves you uninsured at 50 "
            "when your health might not qualify you for a new one. If it is whole life, the premiums "
            "are usually higher but it builds cash value. Either way, knowing what type opens the "
            "conversation naturally.\n\n"

            "ANGLE 9 — THE BENEFICIARY CHECK:\n"
            "'Last thing — do you know who your beneficiary is currently?' This sounds simple but "
            "a surprising number of people have an ex-spouse, a deceased parent, or nobody listed. "
            "It is a genuine service question that has nothing to do with selling. If their beneficiary "
            "is wrong, they need to fix that regardless.\n\n"

            "ANGLE 10 — THE COMPARISON OFFER:\n"
            "'Would it be worth doing a quick comparison just to make sure you are getting the best "
            "rate for what you have? It takes two minutes and there is zero obligation.' "
            "Position yourself as a second opinion. Doctors do it. Mechanics do it. "
            "Why would you not get a second opinion on something protecting your family?\n\n"

            "ANGLE 11 — THE COMPLIMENT AND PIVOT:\n"
            "'Good for you — seriously, most people do not even have that much figured out.' "
            "Compliment them for being responsible. Then pivot: 'The only reason I ask is that "
            "most people I talk to who think they are covered find out their plan has a gap they "
            "did not know about. Usually takes 30 seconds to check.'\n\n"

            "ANGLE 12 — THE DEBT OUTLIVES YOU:\n"
            "'Totally makes sense. Quick thought though — does your coverage account for your mortgage? "
            "Student loans? Any debt?' Most people insure their income but forget that debt does not "
            "die with them. The family inherits the financial burden. This is not fear-mongering — "
            "it is a practical gap most people never think about.\n\n"

            "=== RULES ===\n"
            "- Pick ONE angle per message. Never stack multiple angles.\n"
            "- Read the conversation history. Do NOT repeat an angle you already used.\n"
            "- Keep it 1-3 sentences. Do not write a paragraph.\n"
            "- Never say 'your coverage probably is not enough.' Let them discover the gap.\n"
            "- Respect what they have. You are adding, not replacing.\n"
            "- Be warm, genuine, and curious. Never desperate or pushy.\n"
        )
