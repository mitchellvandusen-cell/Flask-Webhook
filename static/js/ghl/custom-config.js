/**
 * InsuranceGrokBot GHL Extension — Config Panel (Part 3 of 3)
 *
 * Spam protection status, business profile, number management,
 * voice integrity, A2P 10DLC, voice config, and SMS bot config.
 *
 * Depends on custom-core.js (must load first).
 */
